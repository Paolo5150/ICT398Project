...
{       
    ...
    vec2 P = p_viewDir.xy / p_viewDir.z * material.height_scale;
    ...
    float beforeDepth = texture(heightMap, prevTexCoords * material.UVScale).r - currentLayerDepth + layerDepth;
